...
public enum MobEnums {
    ...
    Old_Wolf("old_wolf_50", "Old_Wolf", 50, MobGroupEnums.Wolf, Islands.HUB),
    Chicken("farming_chicken_1", "Chicken", 1, MobGroupEnums.Chicken, Islands.THE_FARMING_ISLANDS),
    Cow("farming_cow_1", "Cow", 1, MobGroupEnums.Cow, Islands.THE_FARMING_ISLANDS),
    Mushroom_Cow("mushroom_cow_1", "Mushroom_Cow", 1, MobGroupEnums.Cow, Islands.THE_FARMING_ISLANDS),
    ...
    Jockey_Shot_Silverfish_3("jockey_shot_silverfish_3", "Silverfish", 3, MobGroupEnums.Silverfish, Islands.SPIDERS_DEN),
    Jockey_Shot_Silverfish_42("jockey_shot_silverfish_42", "Silverfish", 42, MobGroupEnums.Silverfish, Islands.SPIDERS_DEN),
    Splitter_Spider_Silverfish_2("splitter_spider_silverfish_2", "Silverfish", 2, MobGroupEnums.Silverfish, Islands.SPIDERS_DEN),
    ...
    Wise_Dragon("wise_dragon_100", "Ender Dragons", 100, MobGroupEnums.Ender_Dragons, Islands.THE_END),
    Superior_Dragon("superior_dragon_100", "Ender Dragons", 100, MobGroupEnums.Ender_Dragons, Islands.THE_END),
    Strong_Dragon("strong_dragon_100", "Ender Dragons", 100, MobGroupEnums.Ender_Dragons, Islands.THE_END),
    Unstable_Dragon("unstable_dragon_100", "Ender Dragons", 100, MobGroupEnums.Ender_Dragons, Islands.THE_END),
    Endstone_Protector("corrupted_protector_100", "Endstone Protector", 100, MobGroupEnums.Endstone_Protector, Islands.THE_END),
    Voidling_Extremist("voidling_extremist_100", "Voidling Extremist", 100, MobGroupEnums.Enderman, Islands.THE_END),
    Voidling_Fanatic("voidling_fanatic_85", "Voidling Fanatic", 85, MobGroupEnums.Enderman, Islands.THE_END),
    Nest_Endermite_50("nest_endermite_50", "Nest Endermite", 50, MobGroupEnums.Endermite, Islands.THE_END),
    Endermite_37("endermite_37", "Endermite", 37, MobGroupEnums.Endermite, Islands.THE_END),
    Endermite_40("endermite_40", "Endermite", 40, MobGroupEnums.Endermite, Islands.THE_END),
    Obsidian_Defender("obsidian_wither_55", "Obsidian Defender", 55, MobGroupEnums.Obsidian_Defender, Islands.THE_END),
    Watcher("watcher_55", "Watcher", 55, MobGroupEnums.Watcher, Islands.THE_END),
    Zealot_Enderman("zealot_enderman_55", "Zealot", 55, MobGroupEnums.Enderman, Islands.THE_END),
    Zealot_Bruiser("zealot_bruiser_100", "Zealot", 100, MobGroupEnums.Enderman, Islands.THE_END),
...
//    Emerald_Slime_5("emerald_slime_5", "Emerald Slime" 5, MobGroupEnums.Emerald_Slime, Islands.DEEP_CAVERNS),
//    Emerald_Slime_10("emerald_slime_10", "Emerald Slime" 10, MobGroupEnums.Emerald_Slime, Islands.DEEP_CAVERNS),
//    Emerald_Slime_15("emerald_slime_15", "Emerald Slime" 15, MobGroupEnums.Emerald_Slime, Islands.DEEP_CAVERNS),
//    Null("", "" , MobGroupEnums., Islands.DEEP_CAVERNS),
//    Null("", "" , MobGroupEnums., Islands.DEEP_CAVERNS),
//    Null("", "" , MobGroupEnums., Islands.DEEP_CAVERNS),
//    Null("", "" , MobGroupEnums., Islands.DEEP_CAVERNS),
//    Null("", "" , MobGroupEnums., Islands.DEEP_CAVERNS),
