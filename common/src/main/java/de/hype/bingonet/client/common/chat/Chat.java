...
public class Chat {
    ...
    public void processThreaded(de.hype.bingonet.client.common.chat.Message message) {
        if (message.getString() != null) {
            ...
            if (!EnvironmentCore.utils.isWindowFocused()) {
                if (BingoNet.generalConfig.doDesktopNotifications) {
                    ...
                    if (!none && (matchesAll || matchesNick)) {
                        ...
                        else if (message.source == de.hype.bingonet.shared.objects.Message.MessageSource.ALL_CHAT)
            ...
            } else if (message.source == de.hype.bingonet.shared.objects.Message.MessageSource.NPC) {
