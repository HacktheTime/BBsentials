...
public abstract class CustomItemTexture {
    ...
    /**
     * @param nameSpace
     * @param renderTextureId keep in mind that the texture probably needs to be in Texturepackfolder/assets/bingonet/textures/gui/sprites/likeyouwant
     */
