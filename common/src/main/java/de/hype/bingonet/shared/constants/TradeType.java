...
public enum TradeType {
    ...
    SLAYER_TIER_4("Slayer Level 4 Goal", "Help for Slayer Level 4 Goal. Done with either Zombie or Spider Tier 4s.", "Be able to kill Zombie and Spider Tier 4s in 30 seconds or less.", 2, TradeTypeEnvironmentRegistry.SLAYER_TIER_4),
    SLAYER_TIER_5("Slayer Level 5 Goal", "Help for Slayer Level 5 Goal. Done with either Zombie or Spider Tier 4s.", "Be able to kill Zombie and Spider Tier 4s in 15 seconds or less.", 2, TradeTypeEnvironmentRegistry.SLAYER_TIER_5),
