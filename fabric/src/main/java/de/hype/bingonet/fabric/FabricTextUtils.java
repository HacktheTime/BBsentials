...
public class FabricTextUtils implements TextUtils {
    ...
    @Override
    public de.hype.bingonet.client.common.mclibraries.interfaces.Text createText(String content) {
        return new de.hype.bingonet.fabric.Text(Text.literal(content));
    }
